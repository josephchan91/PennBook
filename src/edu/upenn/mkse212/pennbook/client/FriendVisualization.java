...
public class FriendVisualization {
	 ...
	 * @return
	 */
	public static final native JavaScriptObject createGraph(final String content, final PennBook parent) /*-{
		 //init Hypertree
		var ht = new $wnd.$jit.Hypertree({
		    ...
		    onCreateLabel: function(domElement, node){
		        ...
		        domElement.onclick = function () {
					parent.@edu.upenn.mkse212.pennbook.client.PennBook::showNodeDetails(Ljava/lang/String;)(node.id.toString());
